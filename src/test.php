...
use Eaglewatch\Web3Search\Blockchair;


$scan = new Blockchair("enter your api key here");
$hash = "0xea9641bf0ec642fad2c81efb7e2fd9b865146267cbd59fefef9d6cbe935d4a02";
$data = ['heights', 'mempool'];
...
$search = $scan->setBlockchain('bitcoin')->getAddressData("1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa");
